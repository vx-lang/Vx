...
2. **Unified Middle-End:** We retain MLIR as our universal intermediate representation without needing to transpile source code to `.rs`.
3. **Instant Maturity:** We gain the memory safety, heavily audited cryptography, and blisteringly fast SIMD collections of the Rust ecosystem on Day 1.
...
2. **The Rust Backend (`libvx_std.rs`)**
