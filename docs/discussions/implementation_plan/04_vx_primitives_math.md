...
> 2. **SIMD Intrinsics:** Does Vx have a native SIMD/Vector type in the AST (like `f32x4`), or should SIMD intrinsics take pointers/arrays of primitives as arguments?
