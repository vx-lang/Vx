...
> 1. **Reviewing C++ Code:** Since MLIR C++ can be quite verbose, do you want me to write the full Tablegen and C++ rewrite patterns first, or would you prefer to mock the pass structure and test the Rust FFI connection first?
