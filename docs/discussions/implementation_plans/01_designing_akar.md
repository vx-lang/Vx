...
1. **Intermediate Representation (IR)**: We will definitely proceed with **MLIR**. This will allow us to define an Akar dialect that natively encodes topologies before lowering to specific accelerator dialects.
