...
MODULE_BLURB = {
    ...
    "iter": "`Range` and `range`; importing it brings the trait and the adaptors too.",
    "iter::adapters": "The iterators `Iterator`'s adaptor methods build: `Map`, `Filter`, `Chain` and the rest.",
