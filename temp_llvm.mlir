module {
  ...
  ^bb6:  // pred: ^bb5
    ...
    %64 = llvm.fmul %57, %63 : f32
    %65 = llvm.fadd %51, %64 : f32
  ...
  ^bb6:  // pred: ^bb1
    ...
    llvm.call @printMemrefF32(%73, %74) : (i64, !llvm.ptr) -> ()
    llvm.return %0 : i32
  }
}
