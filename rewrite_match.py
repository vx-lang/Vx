...
# Replace generate_match_chain
match_chain_pattern = r"pub fn generate_match_chain\s*<\s*'c\s*>\s*\(.*?\}\n\npub\(crate\) fn generate_statements_with_break_guard"
match_chain_replacement = """pub fn generate_match_chain<'c>(
...
content = re.sub(match_chain_pattern, match_chain_replacement, content, flags=re.DOTALL)
