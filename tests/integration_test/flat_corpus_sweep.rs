...
const KNOWN_DECLINES: &[&str] = &[
    ...
    "assert_runtime.vx",
    "autodiff/autodiff_basic.vx",
    "autodiff/autodiff_jvp_vjp_pass.vx",
    "autodiff/autodiff_math_abs_neg.vx",
    "autodiff/autodiff_math_abs_pos.vx",
    "autodiff/autodiff_math_cos.vx",
    "autodiff/autodiff_math_exp.vx",
    "autodiff/autodiff_math_sin.vx",
    "autodiff/autodiff_math_sqrt.vx",
    "benchmark_test.vx",
    ...
    "option_unwrap.vx",
    "pointer_cast.vx",
    "scalar_print_narrow.vx",
    "spliced_block_tails.vx",
    "tensor_element_type.vx",
